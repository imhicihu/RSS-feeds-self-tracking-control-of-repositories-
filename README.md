...
This repo's purpose its a way to monitor all the RSS feeds of our repos. A kind of `Grand Central Station` with just one  _raison d'être_: to visualize all data graphically. Some tools in mind: [D3.js](https://d3js.org/); [HighCharts](https://www.highcharts.com/demo) plus some more.
